...
| `08_nm_lesson_drafts/nml3/NML3_IMPRESSED_FORCE_TERMINOLOGY_DECISION_2026-08-12.md` | Ratified force-member naming authority | `impressed-force` is the sole active headword. It replaces the predecessor member names preserved in old captures, handoffs, backups, and writing passes. Warrant is an admission condition, not a competing headword. |
