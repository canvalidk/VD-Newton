...
=
\sum_{i\in\operatorname{interaction\text{-}set}(M)}
\mathbf F_{\mathrm{impressed}}(i\to M).
$$

Each indexed interaction supplies the target-side `impressed-force`.

Under the 2026-08-26 naming decision, the Force-Sum triplet is:
